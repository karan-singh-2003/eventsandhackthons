          ...
          <div className="flex items-center space-x-2">
            ...
            <div>
              ...
              <p className="text-sm mt-1">
                Unable to access workspace information. Please ensure
                you&apos;re in a valid workspace.
              </p>
            </div>
          </div>
        </div>
    ...
    <div className="space-y-6">
      ...
      <div className="space-y-3">
        ...
        <p className="text-base text-gray-600 dark:text-gray-300 leading-relaxed">
          ...
          Members joining through this link will be assigned the default Member
          role and the link will automatically expire after 7 days for security.
        </p>
      </div>
      ...
      <div className="bg-gray-50 dark:bg-gray-800/50 p-4 rounded-lg space-y-3">
        ...
        <Input
          ...
          className="text-gray-900 dark:text-white bg-white dark:bg-gray-900 
            border border-gray-300 dark:border-gray-600 rounded-lg px-4 h-12
        ...
        <div className="flex items-center justify-between">
          <div className="space-y-1">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-300">
              When enabled, you&apos;ll need to manually review and approve each
              member before they can access the workspace
            </p>
          </div>
          <Switch
            id="invite-toggle"
      ...
      <div className="space-y-4">
        <div className="space-y-2">
          ...
          <p className="text-base text-gray-600 dark:text-gray-300 leading-relaxed">
            Send personalized invitation emails to specific people. You can add
            multiple email addresses and assign them a specific role in your
            workspace.
          </p>
        </div>
