    ...
    >
      ...
      Create Workspace
        ...
        <Select onValueChange={onSelect} value={currentWorkspaceSlug}>
          <SelectTrigger className="h-[32px] w-[32px] p-[8px] bg-white hover:bg-gray-50 border border-gray-300 shadow-sm rounded-md flex items-center justify-center">
            <div className="text-sm font-semibold text-gray-900">
              {currentWorkspace?.workspaceName?.[0]?.toUpperCase() || 'W'}
            </div>
          </SelectTrigger>
          <SelectContent className="bg-white text-gray-800 border border-gray-300 sm:w-[80px] lg:w-[280px] p-0">
            <div className="lg:max-h-[230px] max-h-[750px] overflow-y-auto px-2 py-2">
              {Array.isArray(workspaces?.data) &&
                workspaces.data.map((workspace: any) => (
                  ...
                  >
                    <div
                      className="lg:w-8 lg:h-8 h-8 w-8 flex items-center justify-center rounded-full text-white font-bold lg:text-sm text-xl"
                      style={{
                        backgroundColor: getColorForString(workspace.workspaceName),
                      }}
                    >
      ...
      {/* Workspace name */}
      <div className="lg:ml-3 ml-3 mt-2 lg:mt-2 lg:text-sm text-xs font-sans flex uppercase font-[550] text-[#363636] m-2">
...
//   >
//     <div className="lg:text-sm text-sm font-sans font-[600] text-gray-900">
//       {currentWorkspace?.workspaceName?.[0]?.toUpperCase() || 'W'}
//     </div>
//   </SelectTrigger>
