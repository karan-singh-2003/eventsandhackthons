...
import WorkspaceNavbar from '@/components/dashboardcomponent/WorkspaceNavbar'
import Slider from '@/components/dashboardcomponent/WorkspaceSlider'
...
import BottomNavigation from '@/components/dashboardcomponent/BottomNavigation'
