  ...
  return (
    <div className="flex flex-col items-center h-screen">
      ...
      <div className="flex flex-col items-center mt-16 w-full   lg:max-w-md xl:max-w-lg px-4">
        ...
        <h3 className="text-[#474747] text-sm sm:text-sm lg:text-sm xl:text-base font-medium mt-2 mb-4 px-4 text-center">
        ...
        >
          ...
          <Button
            ...
            className={`h-11 sm:h-12 lg:h-12 mt-4 w-full rounded-none text-white text-sm sm:text-sm lg:text-sm ${
              !isValid || isPending
