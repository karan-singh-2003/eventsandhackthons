...
import useRedirectToLastActiveWorkspace from "@/hooks/useRedirectToWorkspaces"

export default function LandingPageRedirect() {
  useRedirectToLastActiveWorkspace()
...
// import { redirectToWorkspace } from '@/hooks/useRedirectToWorkspaces'
